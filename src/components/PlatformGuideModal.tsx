      ...
      <div className="platform-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="platform-modal-header">
          <div className="header-content">
            <div>
              <h2 className="modal-title">📱 How to Use Your Emojis</h2>
              <p className="modal-subtitle">Choose your platform for step-by-step instructions</p>
            </div>
        ...
        <div className="platform-content">
          <h3 className="platform-title">{guide.title}</h3>
